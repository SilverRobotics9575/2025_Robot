...
public class FeederSubsystem extends SubsystemBase {
    ...
    private final SparkMax feederMotor = new SparkMax(FeederConstants.FEEDER_MOTOR_CAN_ID, MotorType.kBrushless);
    ...
    public FeederSubsystem(LightsSubsystem lightsSubsystem) {
        ...
        config.inverted(FeederConstants.FEEDER_MOTOR_INVERTED)
